...
import io.joern.bytecode.parser.php8.Basics.{anyLetter, anyNumber}
...
object HeaderBlock {
  ...
  def parseHeaderBlockMethodDefinitionLine[_: P]
    ...
    P(getHeaderBlockMethodIdentifier ~ ":\n" ~ " ".rep ~ "; " ~ parseHeaderBlockMethodMetaBlock)
  ...
  def getHeaderBlock[_: P]: P[(MethodHeader,
                               MethodHeaderMetaParsingInfo,
                               MethodHeaderMetaFileInfo,
                               MethodHeaderRangeLine)] =
    P(
